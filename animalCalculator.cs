...
double dailyFood = foodInput * countInput;
double weeklyFood = 7 * dailyFood;
Console.WriteLine($"Total Daily Food: {dailyFood} lbs");
Console.WriteLine($"Total Weekly Food: {weeklyFood} lbs");
